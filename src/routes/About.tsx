    ...
    return (
        <div className="px-8 py-16 max-w-screen-xl mx-auto">
            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">Welcome to Our Store</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">Search and Notifications</h2>
                <p className="text-base text-[#555] leading-relaxed">
            ...
            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">User Management</h2>
                <p className="text-base text-[#555] leading-relaxed">
            ...
            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">Product Management</h2>
                <p className="text-base text-[#555] leading-relaxed">
            ...
            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">Shopping Cart</h2>
                <p className="text-base text-[#555] leading-relaxed">
            ...
            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">Admin Dashboard</h2>
                <p className="text-base text-[#555] leading-relaxed">
                ...
                <ul className="list-none pl-0">
                    <li className="mb-4 text-base text-[#666]">
                        <strong className="text-[#3f1a0d]">Manage Products:</strong> Administrators can view, create, edit, and delete products. This tab provides all the tools needed to keep the product catalog up to date and well-organized.
                    </li>
                    <li className="mb-4 text-base text-[#666]">
                        <strong className="text-[#3f1a0d]">Manage Users:</strong> This tab allows administrators to view and delete users.
                    </li>
                    <li className="mb-4 text-base text-[#666]">
                        <strong className="text-[#3f1a0d]">Manage Orders:</strong> Administrators can view all orders, change their status, and cancel orders if necessary. This tab helps in efficiently managing and tracking customer orders.
                    </li>
                    <li className="mb-4 text-base text-[#666]">
                        <strong className="text-[#3f1a0d]">Analytics:</strong> This tab offers detailed sales analytics based on selected date ranges. Administrators can track sales performance and make informed decisions based on real-time data.
                    </li>
                    <li className="mb-4 text-base text-[#666]">
                        <strong className="text-[#3f1a0d]">CRM System (Leads):</strong> This tab is dedicated to managing leads and messages, providing a streamlined system for handling customer interactions and potential sales opportunities.
                    </li>
                </ul>
            </section>

            <section className="mb-8">
                <h2 className="text-2xl text-[#3f1a0d] mb-4">Backend and Technology</h2>
                <p className="text-base text-[#555] leading-relaxed">
